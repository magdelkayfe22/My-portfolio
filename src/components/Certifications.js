  ...
  <section className="certifications-section">
    ...
    <div className="cert-badges">
      <div className="cert-badge">
        ...
        <a href="/cisco.png" target="_blank" rel="noopener noreferrer">
          <img src="/cisco.png" alt="Cisco Intro to Cybersecurity Certificate" className="cert-img cert-img-large" />
        </a>
      </div>
      <div className="cert-badge">
